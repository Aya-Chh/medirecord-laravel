...
class UpdateDossierMedicalRequest extends FormRequest
{
    ...
    {
        // The user can update their own dossier medical (if they are the patient) or 
        // an admin or medecin (if they are the medic of the consultation linked to the dossier, or admin).
        // We assume that the controller will check the policy for the dossier medical.
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'sometimes|required|in:rapport,analyse,imagerie,autre',
            'fichier_path' => 'sometimes|nullable|string|max:255',
        ];
    }
